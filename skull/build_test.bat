...
REM Include display_adapter.c and game_window.c for display functions
cl /W3 /O2 /MD /Fe:test_functions.exe test_functions.c dos_compat.c skull_ported.c function_stubs.c display_adapter.c game_window.c /wd4244 /wd4312 /wd4013 /wd4311 /wd4101 /wd4142 /wd4047 /wd4024 /wd4018 /wd4146 /wd4554 /wd4700 /wd4996 /link kernel32.lib user32.lib gdi32.lib
